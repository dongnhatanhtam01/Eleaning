        ...
        {(appState.account.chiTietKhoaHocGhiDanh != "") ? appState.account.chiTietKhoaHocGhiDanh.map((item, index) => {
          return (
            <tr key={index}>
              ...
              {/* <td><button type="button" class="btn btn-light btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
              ...
              <td><button type="button" class="btn btn-light btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-circle-fill" viewBox="0 0 16 16">
